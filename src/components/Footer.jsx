...
export const Footer = () => {
    return(
        <footer className='bg-[#90d4c6] py-16 '>
            <img src={logoGreen} className='mx-auto mb-10'/>
            <div className='flex w-[297px] place-content-between mx-auto text-Dark-desaturated-cyan text-lg 
            font-Barlow mb-[88px]'>
